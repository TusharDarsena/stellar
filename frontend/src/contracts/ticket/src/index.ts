...
// Removed wildcard exports to fix Vite interop issue
...
export const networks = {
  testnet: {
    ...
    contractId: "CBBAXNKBJ4HINCQFTCLCHED6X77EOXNXOZ4MUORHJVZT6WR46KRTZZCJ",
  }
} as const
 ...
 */
export type DataKey = {tag: "Event", values: readonly [string]} | {tag: "Ticket", values: readonly [string]} | {tag: "Escrow", values: readonly [string]} | {tag: "MarketplaceAddress", values: void} | {tag: "XlmToken", values: void};
...
export interface Client {
   ...
   */
  initialize: ({marketplace_address, xlm_token}: {marketplace_address: string, xlm_token: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAGcmVmdW5kAAAAAAACAAAAAAAAAAl0aWNrZXRfaWQAAAAAAAARAAAAAAAAAAhhdHRlbmRlZQAAABMAAAABAAAD6QAAAAIAAAfQAAAADUNvbnRyYWN0RXJyb3IAAAA=",
        "",
        "AAAAAAAAAAAAAAAJZ2V0X2V2ZW50AAAAAAAAAQAAAAAAAAAIZXZlbnRfaWQAAAARAAAAAQAAA+kAAAfQAAAABUV2ZW50AAAAAAAH0AAAAA1Db250cmFjdEVycm9yAAAA",
        "AAAAAAAAAAAAAAAJbWFya191c2VkAAAAAAAAAgAAAAAAAAAJdGlja2V0X2lkAAAAAAAAEQAAAAAAAAAJb3JnYW5pemVyAAAAAAAAEwAAAAEAAAPpAAAAAgAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
        "AAAAAAAAAAAAAAAKZ2V0X3RpY2tldAAAAAAAAQAAAAAAAAAJdGlja2V0X2lkAAAAAAAAEQAAAAEAAAPpAAAH0AAAAAZUaWNrZXQAAAAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
        "",
        "AAAAAAAAAExDYW5jZWwgZXZlbnQuIE9ubHkgb3JnYW5pemVyLiBEb2VzIG5vdCBhdXRvLXJlZnVuZCDigJQgcHVsbC1iYXNlZCBwZXIgRC0wMDIuAAAADGNhbmNlbF9ldmVudAAAAAIAAAAAAAAACGV2ZW50X2lkAAAAEQAAAAAAAAAJb3JnYW5pemVyAAAAAAAAEwAAAAEAAAPpAAAAAgAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
        "",
        ...
        "",
        "AAAAAAAAAAAAAAAPZ2V0X21hcmtldHBsYWNlAAAAAAAAAAABAAAD6QAAABMAAAfQAAAADUNvbnRyYWN0RXJyb3IAAAA=",
        "",
        ...
        "",
        "",
        "",
